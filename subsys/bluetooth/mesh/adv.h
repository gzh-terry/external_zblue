...
#define MESH_SCAN_INTERVAL       CONFIG_BT_MESH_SCAN_INTERVAL
#define MESH_SCAN_WINDOW         CONFIG_BT_MESH_SCAN_WINDOW
#define BT_MESH_SCAN_INTERVAL_MS MESH_SCAN_INTERVAL
#define BT_MESH_SCAN_WINDOW_MS   MESH_SCAN_WINDOW
